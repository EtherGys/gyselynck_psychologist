            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    <a href="/" className="text-[#292222]">
                        <p className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Éléonore Gyselynck</p>
                        <p className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Psychologue clinicienne agréée</p>
                    </a>
                    <div className="flex items-center space-x-6 rtl:space-x-reverse">
                        <button type="button" className="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-[#9CCC65] focus:outline-none bg-white rounded-full border border-[#9CCC65] hover:bg-[#BBE090] hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-100 dark:text-gray-400 dark:border-gray-600">Prendre rendez-vous</button>
                        <button type="button" className="flex flex-row text-white bg-[#9CCC65] hover:bg-[#BBE090] focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">
