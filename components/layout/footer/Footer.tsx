...
function Footer() {
  return (
    <div>
      {/* <!-- Footer container --> */}
      <footer className="text-center text-surface/75  lg:text-left font-roboto text-white">
          ...
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="">
              <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
                <span className="me-3 [&>svg]:h-4 [&>svg]:w-4">
                  <img
                    className="w-6 h-6"
                    src="/assets/logos/logo_yellow_on_black.png"
                    alt="logo d'Éléonore Gyselynck"
                  />
                </span>
                Éléonore Gyselynck
              </h6>
            ...
            <div>
              ...
              <p className="mb-4 flex items-center justify-center md:justify-start">
                ...
                Sur RDV, le mardi et vendredi de 9h à 17h
              </p>
              <p className="mb-4 flex items-center justify-center md:justify-start">
                <span className="me-3 [&>svg]:h-5 [&>svg]:w-5">
                  <svg
        ...
        <div className="bg-black text-white  p-2 lg:p-6 text-sm lg:text-base text-center">
          <span>
            © 2024 Eléonore Gyselynck, Tous droits réservés. Conçu par Victoria
            Gyselynck
          </span>
        </div>
      </footer>
