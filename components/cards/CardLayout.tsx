...
function CardLayout() {
    return (
        <div className='relative font-montserrat mt-24 mb-10 sm:mt-32 lg:mt-0'>
            ...
            <div className='absolute -top-20 lg:top-48 mx-auto z-10 flex flex-col lg:flex-row justify-around left-5 sm:left-40 md:left-48 lg:left-20 xl:left-24 w-[90%] lg:w-[85%] '>
                <Card
