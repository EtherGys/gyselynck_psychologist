...
export const metadata: Metadata = {
  ...
  description: "Consultations psychologiques à Overijse et en ligne. Psychologue clinicienne agréée pour adultes et adolescents. Séances de 50 minutes à 65€. Prise de rendez-vous en ligne.",
  keywords: ["consultation psychologique overijse", "psychologue adulte", "psychologue adolescent", "séance psychologie", "prix consultation", "rendez-vous psychologue"],
  openGraph: {
    title: "Consultations psychologiques - Eléonore Gyselynck",
    description: "Consultations psychologiques à Overijse et en ligne. Psychologue clinicienne agréée pour adultes et adolescents.",
    images: [
      {
        url: '/assets/images/porte.jpeg',
        width: 1200,
        height: 630,
        alt: 'Porte de consultation psychologique',
      },
    ],
  },
  alternates: {
          ...
          <div>
            <ul className='px-8 font-roboto lg:text-xl'>
              <li className='flex mt-2'>
                <span className='w-12'>
                  <img src="assets/icons/up-arrow.png" alt="flêche vers le haut" className='rotate-90 mr-4' width={30} />
                </span>
